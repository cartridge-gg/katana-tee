...
fn test_commitment_matches_cairo() {
    ...
    // value = 0x3
    let key =
        Felt::from_hex("0x7ebcc807b5c7e19f245995a55aed6f46f5f582f476a886b91b834b0ddf5854").unwrap();
    ...
    let key_bytes = Bytes::from(
        hex::decode("007ebcc807b5c7e19f245995a55aed6f46f5f582f476a886b91b834b0ddf5854").unwrap(),
    );
